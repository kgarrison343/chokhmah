...
fn verify_password_with_salt(password_hash: Credential, attempted_password: &str, salt: Vec<u8>) -> bool {
...
mod tests {
    ...
    pub fn verify_with_salt_test() {
        ...
        let success = hashing::verify_password_with_salt(actual_hash, password_attempt, salt);
